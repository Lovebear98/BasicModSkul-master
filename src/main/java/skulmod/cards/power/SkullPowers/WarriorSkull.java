...
public class WarriorSkull extends BaseCard implements SpawnModificationCard {
    ...
    public WarriorSkull(CardInfo cardInfo) {
        super(cardInfo);
    }
    @Override
    ...
    public void onChoseThisOption() {
        ...
        addToBot(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, (new WarriorSkullPower(AbstractDungeon.player, -1))));
        if(AbstractDungeon.player instanceof LittleBone){
            ((LittleBone) (AbstractDungeon.player)).AnimateSkull(AtlasPaths.WarriorAnim(), "IDLE");
