package skulmod.cards.power.champion;
...
public class RageMode extends BaseCard implements SpawnModificationCard {
    ...
    public RageMode(CardInfo cardInfo) {
        super(cardInfo);
    }
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p, p, new skulmod.powers.custompowers.forms.RageMode(p, magicNumber)));
    }
