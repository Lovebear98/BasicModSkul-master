...
import skulmod.powers.custompowers.skulls.ShieldSkullPower;
...
public class ShieldSkull extends BaseCard implements SpawnModificationCard {
    ...
    public ShieldSkull(CardInfo cardInfo) {
        super(cardInfo);
    }
    ...
    public void onChoseThisOption() {
        ...
        addToBot(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, (new ShieldSkullPower(AbstractDungeon.player, -1))));
        if(AbstractDungeon.player instanceof LittleBone){
            ((LittleBone) (AbstractDungeon.player)).AnimateSkull(AtlasPaths.ShieldSkullAnim(), "IDLE");
