...
import skulmod.powers.custompowers.skulls.WerewolfPower;
...
public class WerewolfSkull extends BaseCard implements SpawnModificationCard {
    ...
    public WerewolfSkull(CardInfo cardInfo) {
        super(cardInfo);
    }
    ...
    public void onChoseThisOption() {
        ...
        addToBot(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, (new WerewolfPower(AbstractDungeon.player, -1))));
        ActiveSkull = this;
        if(AbstractDungeon.player instanceof LittleBone){
            ((LittleBone) (AbstractDungeon.player)).AnimateSkull(AtlasPaths.WerewolfAnim(), "IDLE");
