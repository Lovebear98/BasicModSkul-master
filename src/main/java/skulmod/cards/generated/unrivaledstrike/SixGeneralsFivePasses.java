...
public class SixGeneralsFivePasses extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "SixGeneralsFivePasses",
            -2,
            CardType.SKILL,
            CardTarget.NONE,
            CardRarity.SPECIAL,
    ...
    public SixGeneralsFivePasses(CardInfo cardInfo) {
        super(cardInfo);
    }
    ...
    public AbstractCard makeCopy() { //Optional
        return new SixGeneralsFivePasses();
    }
}