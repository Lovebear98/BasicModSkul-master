...
public class Cannonball extends CustomOrb {

    // Standard ID/Description
    public static final String ORB_ID = makeID("Cannonball");
    ...
    public Cannonball() {
        ...
        super(ORB_ID, orbString.NAME, PASSIVE_AMOUNT, EVOKE_AMOUNT, DESCRIPTIONS[1], DESCRIPTIONS[3], "skulmod/orbs/Cannonball.png");
    ...
    public void playChannelSFX() { // When you channel this orb, the ATTACK_FIRE effect plays ("Fwoom").
        CardCrawlGame.sound.play("SKUL_CANNONBALL", 0.1f);
    }
...
@Override
    public void onEvoke() {
AbstractDungeon.actionManager.addToBottom(new CannonballEvokeAction(AbstractDungeon.player, evokeAmount, false));
