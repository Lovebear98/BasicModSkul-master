...
public class LittleBoneSkull extends BaseCard implements SpawnModificationCard {
    ...
    public LittleBoneSkull(CardInfo cardInfo) {
        super(cardInfo);
    }
    ...
    public void onChoseThisOption() {
        ...
        addToBot(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, (new LittleBonePower(AbstractDungeon.player, -1))));
        ActiveSkull = this;
        if(AbstractDungeon.player instanceof LittleBone){
            ((LittleBone) (AbstractDungeon.player)).AnimateSkull(AtlasPaths.LittleBoneAnim(), "IDLE");
