...
import skulmod.powers.custompowers.skulls.BerserkerSkullPower;
...
@NoCompendium
public class BerserkerSkull extends BaseCard implements SpawnModificationCard {
    ...
    public BerserkerSkull(CardInfo cardInfo) {
        super(cardInfo);
    }
    ...
    public void onChoseThisOption() {
        ...
        addToBot(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, (new BerserkerSkullPower(AbstractDungeon.player, -1))));
        ActiveSkull = this;
        if(AbstractDungeon.player instanceof LittleBone){
            ((LittleBone) (AbstractDungeon.player)).AnimateSkull(AtlasPaths.BerserkerAnim(), "IDLE");
