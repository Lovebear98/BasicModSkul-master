...
public class Barrier extends CustomOrb {

    // Standard ID/Description
    public static final String ORB_ID = makeID("Barrier");
    private static final OrbStrings orbString = CardCrawlGame.languagePack.getOrbString(ORB_ID);
    public static final String[] DESCRIPTIONS = orbString.DESCRIPTION;

    private static final int PASSIVE_AMOUNT = 1; ///Passive End-of-turn
    ...
    public Barrier() {
        ...
        super(ORB_ID, orbString.NAME, PASSIVE_AMOUNT, EVOKE_AMOUNT, DESCRIPTIONS[1], DESCRIPTIONS[3], "skulmod/orbs/Barrier.png");
...
if(passiveAmount > 0){
    AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, new DexterityPower(AbstractDungeon.player, passiveAmount)));
    AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, new LaterDexterityDown(AbstractDungeon.player, passiveAmount)));
}
        super.onEndOfTurn();
    ...
    public void playChannelSFX() { // When you channel this orb, the ATTACK_FIRE effect plays ("Fwoom").
        CardCrawlGame.sound.play("SKUL_SHIELD", 0.6f);
    }
...
@Override
    public void onEvoke() {
if(evokeAmount > 0){
    AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, new DexterityPower(AbstractDungeon.player, evokeAmount)));
    AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, new LaterDexterityDown(AbstractDungeon.player, evokeAmount)));
}
; // 2.Damage all enemies
    ...
    AbstractDungeon.actionManager.addToBottom(new SFXAction("SKUL_SHIELD")); // 3.And play a Jingle Sound.
