...
public abstract class BaseCard extends CustomCard implements OnObtainCard {
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    SkulMod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
