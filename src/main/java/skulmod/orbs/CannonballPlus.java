...
public class CannonballPlus extends CustomOrb {

    // Standard ID/Description
    public static final String ORB_ID = makeID("CannonballPlus");
    ...
    public CannonballPlus() {
        ...
        super(ORB_ID, orbString.NAME, PASSIVE_AMOUNT, EVOKE_AMOUNT, DESCRIPTIONS[1], DESCRIPTIONS[3], "skulmod/orbs/CannonballPlus.png");
    ...
    public void updateDescription() { // Set the on-hover description of the orb
        ...
        description = DESCRIPTIONS[0] + this.evokeAmount + DESCRIPTIONS[1];
        {
 ...
 super.applyFocus();
    ...
    public void playChannelSFX() { // When you channel this orb, the ATTACK_FIRE effect plays ("Fwoom").
        CardCrawlGame.sound.play("SKUL_CANNONBALL2", 0.1f);
    }

    @Override
    public AbstractOrb makeCopy() {
        return new CannonballPlus();
    }
@Override
    public void onEvoke() {

if(evokeAmount > 0){
    AbstractDungeon.actionManager.addToBottom(new CannonballEvokeAction(AbstractDungeon.player, evokeAmount, true));
}
    ...
    AbstractDungeon.actionManager.addToBottom(new SFXAction("ATTACK_FLAME_BARRIER")); // 3.And play a Jingle Sound.
