...
public class EmptyHead extends CustomOrb {

    // Standard ID/Description
    public static final String ORB_ID = makeID("NewOrb");
    ...
    public EmptyHead() {
        ...
        super(ORB_ID, orbString.NAME, PASSIVE_AMOUNT, EVOKE_AMOUNT, DESCRIPTIONS[1], DESCRIPTIONS[3], "skulmod/orbs/EmptyHead.png");
...
@Override
    public void onEvoke() {
    AbstractDungeon.actionManager.addToBottom(new BonepileAction(AbstractDungeon.player, null, null, ActiveSkull));
; // 2.Damage all enemies
    ...
    AbstractDungeon.actionManager.addToBottom(new SFXAction("SKUL_BONE_FRAGMENTS", 0.9F)); // 3.And play a Jingle Sound.
