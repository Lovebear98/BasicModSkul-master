...
import skulmod.cards.generated.grapple.FakeHydraSlam;
...
public class AbsoluteSkull extends BaseCard implements SpawnModificationCard {
    ...
    public AbsoluteSkull() {
        ...
        MultiCardPreview.add(this, new HydraSlam(), new FakeHydraSlam());
    }
    ...
    public AbsoluteSkull(CardInfo cardInfo) {
        super(cardInfo);
    }
    ...
    public void onChoseThisOption() {
        ...
        addToBot(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, (new AbsoluteSkullPower(AbstractDungeon.player, -1))));
        ActiveSkull = this;
        if(AbstractDungeon.player instanceof LittleBone){
            ((LittleBone) (AbstractDungeon.player)).AnimateSkull(AtlasPaths.AbsoluteAnim(), "IDLE");
