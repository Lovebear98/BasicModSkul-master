...
import skulmod.powers.custompowers.skulls.MagePower;
...
public class MageSkull extends BaseCard implements SpawnModificationCard {
    ...
    public MageSkull() {
        ...
        this.cardsToPreview = (new Awakening());
    }
    ...
    public void onChoseThisOption() {
        ...
        addToBot(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, (new MagePower(AbstractDungeon.player, -1))));
        ActiveSkull = this;
        if(AbstractDungeon.player instanceof LittleBone){
            ((LittleBone) (AbstractDungeon.player)).AnimateSkull(AtlasPaths.MageAnim(), "IDLE");
