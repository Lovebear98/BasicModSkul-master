...
public class ClownSkull extends BaseCard implements SpawnModificationCard {
    ...
    public ClownSkull(CardInfo cardInfo) {
        super(cardInfo);
    }
    ...
    public void onChoseThisOption() {
        ...
        addToBot(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, (new ClownPower(AbstractDungeon.player, -1))));
        if(AbstractDungeon.player instanceof LittleBone){
            ((LittleBone) (AbstractDungeon.player)).AnimateSkull(AtlasPaths.ClownAnim(), "IDLE");
