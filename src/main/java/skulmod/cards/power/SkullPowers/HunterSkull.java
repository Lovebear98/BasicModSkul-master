...
import skulmod.powers.custompowers.skulls.HunterPower;
...
public class HunterSkull extends BaseCard implements SpawnModificationCard {
    ...
    public HunterSkull(CardInfo cardInfo) {
        super(cardInfo);
    }
    ...
    public void onChoseThisOption() {
        ...
        addToBot(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, (new HunterPower(AbstractDungeon.player, -1))));
        if(AbstractDungeon.player instanceof LittleBone){
            ((LittleBone) (AbstractDungeon.player)).AnimateSkull(AtlasPaths.HunterAnim(), "IDLE");
