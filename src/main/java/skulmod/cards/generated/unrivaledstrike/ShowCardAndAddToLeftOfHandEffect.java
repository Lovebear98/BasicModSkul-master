...
public class ShowCardAndAddToLeftOfHandEffect extends AbstractGameEffect {
    ...
    public ShowCardAndAddToLeftOfHandEffect(AbstractCard card, float offsetX, float offsetY) {
        this.card = card;
    ...
    public ShowCardAndAddToLeftOfHandEffect(AbstractCard card) {
        this.card = card;
    ...
    private void playCardObtainSfx() {
        ...
        while(var2.hasNext()) {
            ...
            if (e instanceof ShowCardAndAddToLeftOfHandEffect) {
                ++effectCount;
            }
        }
